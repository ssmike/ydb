...
Также реализована экспериментальная возможность выбора вторичного индекса для использования в запросе в автоматическом режиме. 
[Алгоритм выбора](./automatic-index-choosing.md) на данный момент является rule-based и использует только текст запроса для автоматического выбора вторичного индекса.
